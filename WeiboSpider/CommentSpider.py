...
class WeiboComment:
    ...
    def get_weibo_comment(self):
        ...
        UA=random.choice(use_agents) #随机选取use_agents
        ...
        try:
            ...
            for page in range(1, page_num + 1):
                ...
                systime.sleep(1 + float(random.randint(1, 10)) / 40)
        except Exception as e:
            print("Error: ", e)
            traceback.print_exc()
...
def main():
    ...
    f = open(r'G:\code\weibo\id.txt', 'r')
    line = f.readline()
    i=1
    while line:
        line = f.readline()
        comment_id = line[0:9]
        publish_time = line[11:27]
        try:
            if i%20==0:
                systime.sleep(100)# 每爬取20条微博就停止100s
